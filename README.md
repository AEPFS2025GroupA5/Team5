...
## Abschluss
Am Anfang war dieses Projekt für uns eine echte Herausforderung. Vieles war neu, vor allem die Kombination aus Python, objektorientierter Programmierung und dem ganzen technischen Aufbau. Der Einstieg fiel uns nicht leicht, weil wir erst mal verstehen mussten, wie alles überhaupt zusammenhängt. Gleich zu Beginn gab es technische Hürden: Wir haben mit Deepnote gearbeitet, aber es war gar nicht so einfach, unser Projekt korrekt auf GitHub hochzuladen. Dadurch ging wertvolle Zeit verloren, und wir waren teilweise ziemlich unsicher, ob wir überhaupt auf dem richtigen Weg sind. Der Wendepunkt kam, als wir uns als Team zusammengesetzt und beschlossen haben, eine klare Struktur zu schaffen. Wir haben die Aufgaben aufgeteilt, Rollen festgelegt und ein Klassendiagramm erstellt – das hat uns geholfen, die Architektur besser zu verstehen und die Arbeit sinnvoll aufzuteilen. Ein richtiges Aha-Erlebnis hatten wir, als wir es geschafft haben, unsere Datenbank ans Projekt anzubinden. Ab da lief es deutlich runder. Wir haben uns in zwei Teams aufgeteilt – eines für die Struktur der Hotelobjekte, das andere für die Abläufe im Gasterlebnis. Das hat gut funktioniert, aber uns wurde schnell klar, dass wir trotzdem eng zusammenarbeiten müssen, weil die Klassen oft miteinander verbunden sind. Regelmässige Meetings, unsere WhatsApp-Gruppe und später auch ein Kanban-Board auf GitHub haben uns dabei sehr geholfen, den Überblick zu behalten und uns abzustimmen.

Technisch haben wir viel dazugelernt: Die Arbeit mit einer mehrschichtigen Struktur (Model, Data Access, Business Logic und UI) hat uns gezeigt, wie wichtig saubere Trennung und modulare Programmierung sind. Besonders knifflig war die Fehlerbehandlung und das Überprüfen von Nutzereingaben – aber auch da sind wir mit der Zeit sicherer geworden. Auch Jupyter Notebook hat sich als ziemlich praktisch erwiesen: Wir konnten direkt im Code dokumentieren, was wir tun, unsere Gedanken festhalten und Tests nachvollziehen. Das war nicht nur bei der Zusammenarbeit hilfreich, sondern auch beim Zurückblicken. Insgesamt war das Projekt eine richtig gute Erfahrung. Wir haben nicht nur fachlich viel gelernt, sondern auch, wie wichtig gute Kommunikation, klare Strukturen und echtes Teamwork sind. Wir sind stolz auf das, was wir erreicht haben – und würden bei einem nächsten Projekt vieles genauso machen. Nur mit noch ein bisschen mehr Planung von Anfang an.

### Verwendung von ChatGPT
ChatGPT wurde in unseren Projekt unterstützend eingesetzt. Es diente dazu, unsere Lösungen gegen die Aufgabenstellung abzugleichen und sicherzustellen, dass alle Anforderungen erfüllt wurden. Vor allem nutzten wir das Tool, um sprachliche Fehler zu vermeiden und eine präziseren, klareren Schreibstil in unserer Dokumentation zu erreichen. Wir haben uns manchmal auch für Error Fixing im Python von ChatGPT und CoPilot unterstützen lassen.
