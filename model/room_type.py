...
#Funktionen // get für User story 2-2.1 // update info User Story 10
    ...
    def update_info(
        ...
        # Facility
wlan = Facility(1, "WLAN")
pool = Facility(2, "Pool")
oehirher = Facility(3, "Handy")
test = Facility.list_all()

raum1= RoomType(1, "cool", 4, None, "Cool2",[1, 2, 3])        
print(raum1.get_details())
  
# Beispiel-Objekt
#singe1 = RoomType(1, "Single Suite", 1, ["Wlan", "Pool", "Minibar"], "Kleines Einzelzimmer aber nicht schön!")

  
#Details abrufen
#print(singe1.get_details())

# //update prüfe

#singe1.update_info(name="Saliou")
#print(singe1.get_details())
#print(singe1.get_details())    
